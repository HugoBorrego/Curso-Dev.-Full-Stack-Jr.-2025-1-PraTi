...
function Product() {
    ...
    const handleAddProduct = (event) => {
        event.preventDefault() // para não atualizar
        ...
        if (isNaN(price) || Number(price) <= 0) {
            setError('O preço deve ser positivo ou maior que zero.')
            return
        }
        ...
        setProducts([...products, newProduct]) // adicionando o novo elemento na lista
