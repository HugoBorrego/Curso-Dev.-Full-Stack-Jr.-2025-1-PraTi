/*
  ...
  - Contexto (createContext/useContext) é uma forma de compartilhar dados entre vários componentes sem precisar passar props manualmente em cada nível.
  - Ele resolve o problema de "prop drilling" (quando precisamos passar props de um componente pai até um neto/bisneto que realmente usa o dado).
  ...
  - Aqui o contexto armazena o estado de autenticação (usuário logado ou não) e fornece funções de login/logout para toda a aplicação.
*/
