const ContaBancariaProfessor = require('../src/ContaBancariaProfessor')

// Agrupa todos os testes relacionados à Classe ContaBancariaProfessor Avançada
describe('Classe ContaBancariaProfessor Avançada', () => {
  // Declara variáveis que apontarão para instâncias de ContaBancariaProfessor
  ...
  beforeEach(() => {
    // Instancia uma nova ContaBancariaProfessor com número único 'A-001'
    contaA = new ContaBancariaProfessor('A-001');
    // Instancia uma nova ContaBancariaProfessor com número único 'B-002'
    contaB = new ContaBancariaProfessor('B-002');
  });
