 ...
 */
class ContaBancariaProfessorProfessor {
  /**
  ...
  /**
   * Transfere valor para outra ContaBancariaProfessor, registrando em ambos extratos.
   * @param {number} valor
   * @param {ContaBancariaProfessor} contaDestino
   * @throws {Error} se contaDestino inválida ou valor <=0 ou saldo insuficiente
   */
  transferir(valor, contaDestino) {
    if (!(contaDestino instanceof ContaBancariaProfessor)) {
...
module.exports = ContaBancariaProfessorProfessor;