public class ExemplosDeInterfaces {
    ...
    // Contém exatamente um metodo abstrato, usado em expressões lambda
    @FunctionalInterface
    interface InterfaceFuncional {
        void executar(); // Metodo abstrato único
    }
    ...
    interface InterfaceComDefault {
        void metodoObrigatorio(); // Metodo abstrato
    ...
    public static void main(String[] args) {
        ...
        comDefault.metodoOpcional(); // Metodo padrão sendo chamado

        // 4. Usando metodo estático de uma interface
