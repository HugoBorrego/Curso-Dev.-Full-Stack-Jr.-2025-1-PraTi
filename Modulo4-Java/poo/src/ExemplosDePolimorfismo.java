public class ExemplosDePolimorfismo {
     ...
     * Uma subclasse fornece uma implementação específica para um metodo da classe pai.
     */
    static class Animal {
     ...
     * Um metodo genérico pode operar com diferentes tipos de objetos.
     */
    ...
    /**
     * Metodo principal para demonstrar os exemplos de polimorfismo.
     */
    public static void main(String[] args) {
        ...
        impressora.imprimir(cachorro); // Polimorfismo: o metodo chamar o comportamento específico
