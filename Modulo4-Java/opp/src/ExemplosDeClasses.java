...
public class ExemplosDeClasses {
    ...
    // Classe local
    // Definida dentro de um metodo e só pode ser usada dentro deste metodo
    ...
    public abstract static class ClasseAbstrata {
        public abstract void mostrarMensagem(); // Metodo abstrato que deve ser implementado pelas subclasses
    }
    ...
    // Metodo principal para demonstrar os exemplos
